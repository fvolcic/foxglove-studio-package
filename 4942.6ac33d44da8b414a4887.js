"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[4942],{64942:(Z,l,n)=>{n.d(l,{v:()=>K});const c=[{fileName:"pointClouds.ts",sourceCode:`import { FieldReader, getReader } from "./readers";
...
`}];var t=n(23621),d=n(11701),m=n(81468),u=n(76878),f=n(96627),p=n(5812),b=n(73406),h=n(90748),y=n(62227),g=n(4211),v=n(12771),w=n(16691),x=n(25385),T=n(1902),R=n(40453),P=n(63799),A=n(76100),z=n(36860),M=n(36412),I=n(41831),E=n(24855),C=n(12555),U=n(9080),j=n(19463),B=n(22656),D=n(42192),F=n(34518),N=n(72931),_=n(88823),O=n(4092),S=n(57495),k=n(31582),L=n(34607),G=n(66848),H=n(67780),V=n(95681),Y=n(39977),$=n(83597),Q=n(52822);const s="lib.d.ts",W=`
...
`,r=new Map(Object.entries({es5:Q,es2015:f,es2016:T,es2017:R,es2018:U,es2019:N,"es2015.core":u,"es2015.collection":m,"es2015.iterable":b,"es2015.generator":p,"es2015.promise":h,"es2015.proxy":y,"es2015.reflect":g,"es2015.symbol":v,"es2015.symbol.wellknown":w,"es2016.array.include":x,"es2017.object":A,"es2017.sharedmemory":z,"es2017.string":M,"es2017.intl":P,"es2017.typedarrays":I,"es2018.asynciterable":C,"es2018.asyncgenerator":E,"es2018.promise":B,"es2018.regexp":D,"es2018.intl":j,"es2019.array":F,"es2019.object":_,"es2019.string":O,"es2019.symbol":S,"es2020.bigint":k,"es2020.promise":H,"es2020.sharedmemory":V,"es2020.string":Y,"es2020.symbol.wellknown":$,"es2020.intl":G}));function o(e){return e.replace(/\/\/\/ <reference lib="(.+)" \/>/g,(ln,a)=>{const i=r.get(a);return r.delete(a),i==null?"":o(i)})}const X=`${o(L)}

${W}`,J=c.map(e=>({...e,filePath:`${d.wd}${e.fileName}`}));function K(){const e=[];return e.push({fileName:s,filePath:s,sourceCode:X}),{defaultLibFileName:s,rosLib:{fileName:t.Y,filePath:`/node_modules/${t.Y}`,sourceCode:t.k},declarations:e,utilityFiles:J}}}}]);

//# sourceMappingURL=4942.6ac33d44da8b414a4887.js.map